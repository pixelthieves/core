...
package com.pixelthieves.core.pathfinding.astar;
...
public interface NodeFactory {
    ...
    /**
     * creates new instances of an implementation of the <code>AbstractNode</code>. In an implementation, it should
     * return a new node with its position set to the given x and y values.
     *
